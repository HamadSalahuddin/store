...
namespace Store.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string category = null)
        {
            ...
            viewModelGadgets = AutoMapperConfiguration.mapper.Map<IEnumerable<Category>, IEnumerable<CategoryViewModel>>(categories);
        ...
        public ActionResult Filter(string category, string gadgetName)
        {
            ...
            viewModelGadgets = AutoMapperConfiguration.mapper.Map<IEnumerable<Gadget>, IEnumerable<GadgetViewModel>>(gadgets);
        ...
        public ActionResult Create(GadgetFormViewModel newGadget)
        {
            ...
            {
                var gadget = AutoMapperConfiguration.mapper.Map<GadgetFormViewModel, Gadget>(newGadget);
