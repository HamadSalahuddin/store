...
namespace Store.Service
{
    ...
    public class GadgetService: IGadgetService
    {
        ...
        public GadgetService(
            IGadgetRepository gadgetsRepository,
        ...
        public IEnumerable<Gadget> GetCategoryGadgets(string categoryName, string gadgetName = null)
        {
            ...
            return category.Gadgets
                .Where(gadget => gadget.Name.ToLower().Contains(gadgetName.ToLower().Trim()));
        }
